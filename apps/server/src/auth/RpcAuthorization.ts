...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.providerListPiSessionMessages]: AuthOrchestrationReadScope,
  [WS_METHODS.providerCheckPiSessionUpdates]: AuthOrchestrationReadScope,
  [WS_METHODS.providerSyncPiSessionUpdates]: AuthOrchestrationOperateScope,
  [WS_METHODS.providerGetPiChildLeaseDiagnostics]: AuthOrchestrationReadScope,
