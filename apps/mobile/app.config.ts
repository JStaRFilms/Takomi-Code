...
const config: ExpoConfig = {
  ...
  ios: {
    ...
    infoPlist: {
      ...
      NSPhotoLibraryAddUsageDescription: "Allow Takomi Code to save images to your photo library.",
  ...
  plugins: [
    ...
    [
      "expo-audio",
      {
        microphonePermission: "Allow Takomi Code to use your microphone for voice input.",
