...
The `pi` driver is presented as Takomi in the clients and uses Pi's structured RPC mode. See
[Takomi / Pi provider](../features/takomi-pi-provider.md) for its event mapping and constraints.
