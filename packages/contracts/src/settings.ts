...
export const ClientSettingsSchema = Schema.Struct({
  ...
  // Web and desktop persist client settings locally. Mobile has a separate
  // device-preferences store and does not currently expose completion audio.
  turnCompletePlaySound: Schema.Boolean.pipe(Schema.withDecodingDefault(Effect.succeed(true))),
...
export const PiSettings = makeProviderSettingsSchema(
  {
    ...
    launchArgs: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        title: "Launch arguments",
        description: "Additional CLI arguments passed before T3 Code's required RPC arguments.",
        providerSettingsForm: {
...
export const ClientSettingsPatch = Schema.Struct({
  ...
  turnCompletePlaySound: Schema.optionalKey(Schema.Boolean),
